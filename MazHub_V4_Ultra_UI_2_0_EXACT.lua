...
MainConstraint.MinSize = Vector2.new(320, 400)
MainConstraint.MaxSize = Vector2.new(620, 650)
...
Sidebar.Size = UDim2.new(0, 128, 1, -86)
...
Content.Position = UDim2.fromOffset(148, 76)
Content.Size = UDim2.new(1, -158, 1, -86)
...
do
	local card = CreateCard(
		PlayerPage,
		"Player Controls",
		"Basic player movement and utility settings."
	)

	local container = Instance.new("Frame")
	container.BackgroundTransparency = 1
	container.Position = UDim2.fromOffset(15, 65)
	container.Size = UDim2.new(1, -30, 0, 44)
	...
	-- Actual toggle will be created below in Movement.
end
