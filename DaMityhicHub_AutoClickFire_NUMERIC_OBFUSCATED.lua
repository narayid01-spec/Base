...
Version.Text = "Free  •  Premium Control"
...
do
	...
	h2.Text = "DaMityhicHub • Compact control hub\nBuilt for mobile & desktop."
...
do
	...
	local function _0xS(_0xA)
		local _0xB = {}
		for _0xC, _0xD in ipairs(_0xA) do
			_0xB[_0xC] = string.char(_0xD)
		end
		return table.concat(_0xB)
	end
	...
	local _0x104 = nil
	local _0x105 = {
		_0xS({95,48,120,49,48,52}), _0xS({83,104,111,111,116,66,117,116,116,111,110}), _0xS({70,105,114,101}), _0xS({83,104,111,111,116}), _0xS({83,104,111,111,116,66,116,110}), _0xS({70,105,114,101,66,116,110}), _0xS({83,104,111,111,116,66,117,116,116,111,110,77,111,98,105,108,101}), _0xS({70,105,114,101,66,117,116,116,111,110,77,111,98,105,108,101})
	}

	local function _0x106()
		local _0x10A = LocalPlayer:FindFirstChild(_0xS({80,108,97,121,101,114,71,117,105}))
		if not _0x10A then return nil end

		for _, _0x10C in ipairs(_0x105) do
			local _0x10B = _0x10A:FindFirstChild(_0x10C, true)
			if _0x10B and _0x10B:IsA(_0xS({71,117,105,66,117,116,116,111,110})) and _0x10B.Visible then
				return _0x10B
			end
		end


		for _, _0x10B in ipairs(_0x10A:GetDescendants()) do
			if _0x10B:IsA(_0xS({71,117,105,66,117,116,116,111,110})) and _0x10B.Visible then
				local _0x10D = string.lower(_0x10B.Name)
				local _0x10E = _0xS({})
				if _0x10B:IsA(_0xS({84,101,120,116,66,117,116,116,111,110})) then
					_0x10E = string.lower(_0x10B.Text or _0xS({}))
				end
				if string.find(_0x10D, _0xS({102,105,114,101}), 1, true)
					or string.find(_0x10D, _0xS({115,104,111,111,116}), 1, true)
					or string.find(_0x10E, _0xS({102,105,114,101}), 1, true)
					or string.find(_0x10E, _0xS({115,104,111,111,116}), 1, true) then
					return _0x10B
				end
			end
		end
	...
	local function _0x107()
		local _0x10F = nil
		if State.AutoAimV1 then
			_0x10F = State.CurrentTarget
		elseif AimLockV2.Enabled then
			_0x10F = AimLockV2.Target
		end

		if not _0x10F or not _0x10F.Parent then
			return nil
		end
		if not IsEnemy(_0x10F, State.YourTeam) then
			return nil
		end

		local _0x110 = _0x10F.Character
		local _0x111 = _0x110 and _0x110:FindFirstChildOfClass(_0xS({72,117,109,97,110,111,105,100}))
		local _0x112 = _0x110 and GetAimPart(_0x10F)
		if not _0x111 or _0x111.Health <= 0 or not _0x112 then
			return nil
		end

		local _0x113 = (RootPart.Position - _0x112.Position).Magnitude
		if _0x113 > (AimLockV2.Enabled and AimLockV2.MaxDistance or State.AimDistance) then
			return nil
		end
	...
	local _0x108 = CreateCard(
		CombatPage,
		_0xS({65,117,116,111,32,67,108,105,99,107,32,70,105,114,101}),
		_0xS({70,105,114,101,115,32,116,104,101,32,103,97,109,101,39,115,32,70,105,114,101,47,83,104,111,111,116,32,71,85,73,32,111,110,108,121,32,119,104,105,108,101,32,65,73,77,32,104,97,115,32,97,32,118,97,108,105,100,32,95,48,120,49,48,70,46})
	)

	local _0x109 = Instance.new(_0xS({70,114,97,109,101}))
	_0x109.BackgroundTransparency = 1
	_0x109.Position = UDim2.fromOffset(15, 63)
	_0x109.Size = UDim2.new(1, -30, 0, 45)
	_0x109.Parent = _0x108
	...
	task.spawn(function()
		while Gui and Gui.Parent do
			if _0x102 and (not _0x104 or not _0x104.Parent or not _0x104.Visible) then
				_0x104 = _0x106()
			end
			task.wait(1)
		end
	...
	task.spawn(function()
		while Gui and Gui.Parent do
			if _0x102 then
				local _0x10F = _0x107()
				if _0x10F and _0x104 and _0x104.Parent and _0x104.Visible and _0x104.Active then
					pcall(function()
						_0x104:Activate()
					end)
					task.wait(_0x103)
...
do
	local card = CreateCard(
		DiscoveryPage,
		"DaMityhicHub Discovery",
		"Quick overview of the available modules."
	)
	...
	CreateStatus(container, "● Key System  — DaMityhicHubFreeKey")
end
	...
	function()
		if getclipboard then
			...
			if success and result then
				KeyBox.Text = result
				Notify("DaMityhicHub", "Key pasted.", 2)
			end
		else
			Notify("DaMityhicHub", "Clipboard API not available.", 3)
		end
	end
)
...
local UnlockButton = CreateActionButton(
	...
	function()
		if KeyBox.Text == CONFIG.KEY then
			...
			pcall(function()
				LocalPlayer:Kick("DaMityhicHub: Wrong Key")
			end)
		end
	end
)
